...
| nodejs-api-svc-svelte | A nodejs (typescript) service api with a simple api structure | Typescript, Svelte, Sveltekit, Vite | 5006 | [Branch](https://github.com/chuckamus-prime/ObakeHydra/tree/services/nodejs-api-svc-svelte), [Service Readme](https://github.com/chuckamus-prime/ObakeHydra/tree/services/nodejs-api-svc-svelte/services/nodejs-api-svc-svelte) |
